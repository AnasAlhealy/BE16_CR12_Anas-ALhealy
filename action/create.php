...
if (isset($_POST['save'])) {
    $sql = "INSERT INTO `properties`(`advert_title`, `size`, `room_number`, `city`, `price`, `latitude`, `longitude`, `image`, `price_reduction`) VALUES ('" . addslashes($_POST['advert_title']) . "','" . addslashes($_POST['size']) . "','" . addslashes($_POST['room_number']) . "','" . addslashes($_POST['city']) . "','" . addslashes($_POST['price']) . "','" . addslashes($_POST['latitude']) . "','" . addslashes($_POST['longitude']) . "','" . addslashes($_POST['image']) . "','" . addslashes($_POST['price_reduction']) . "')";
    ...
    <div class="container pt-5">
        ...
        <form method="POST" action="">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="advert_title" />
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="price_reduction" />
            </div>
